...
public class DrawableUtils {
	...
	public static int getRandomColor(){
		return Color.rgb(getRandom(20,210),getRandom(20,210) ,getRandom(20,210));
	}
/**
 * @param range 是在给定的基础上可以浮动多少
 * @param size 原始大小
 * @return
 */
	public static int getRandom(int range,int size) {
		return new Random().nextInt(size)+range;
	}
}
